...
class EmployeeDatabase extends Database {
    ...
    return new Promise((resolve, reject) => {
      this.query(
        `SELECT
                 ...
                 IF(CONCAT(manager.first_name, ' ', manger.last_name) IS NULL, '', CONCAT(manager.first_name, ' ', manager.last_name))
  ...
  addRole(role) {
    ...
    return new Promise((resolve, reject) => {
      this.query("INSERT INTI role SET ?", roleData, (err, results) => {
        if (err) {
          reject(err);
        }
  ...
  addEmployee(employee) {
    ...
    return new Promise((resolve, reject) => {
      this.query("INSERT INTO employee SET ?", employeeData, (err, results) => {
        if (err) {
          reject(err);
        }
        resolve(
